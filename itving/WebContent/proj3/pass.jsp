...
<title>ITVING｜이용권</title>
<meta name="Author" content="CJ ENM">
<meta name="description" content="이용권">
...
<meta property="og:title" content="TVING｜이용권">
<meta property="og:description" content="이용권">
...
<meta name="twitter:title" content="TVING｜이용권">
<meta name="twitter:description" content="이용권">
<meta name="twitter:image" content="https://image.tving.com/public_v6/portal/img/common/tving_log.jpg">
...
<link rel="shortcut icon" href="https://image.tving.com/theme/tving_new/img/logo/favicon.ico" type="image/x-icon">
  ...
  function showPopup1() { window.open("<%=cp%>/itving/popup1.do", "a", "width=500, height=700, left=100, top=50 scrollbars = yes" ); }
  </script>
  
  <script language="javascript">
  function showPopup2() { window.open("<%=cp%>/itving/popup2.do", "a", "width=500, height=700, left=100, top=50 scrollbars = yes" ); }
  </script>
...
<script>
var gaTvingToken = $.cookie('_tving_token') == null ? '' : $.cookie('_tving_token');
var gaValue = '';
var userId = 'ysy9528';
var userType = '10';
...
var gdm009 = resUserTypeJson['dm009_usertype'] == null ? 'U' : resUserTypeJson['dm009_usertype'];		//dm009:ê³ ê°ì í(ë©í°) - A,B,C,AD,BD,CD,D,N,U
var gdm013 = resUserTypeJson['dm013_resIsPaid'] == null ? 'U' : resUserTypeJson['dm013_resIsPaid'];		//dm013:ì ë£/ë¬´ë£ êµ¬ë¶ - ì ë£(P), ë¬´ë£(F), ë¹ë¡ê·¸ì¸(U)
var gdm016 = resUserTypeJson['dm016_TL_FYMD'] == null ? '' : resUserTypeJson['dm016_TL_FYMD'];			//dm016:í°ë¹ë¬´ì í ìµì´ê°ìì¼ - YYMMDD
var gdm017 = resUserTypeJson['dm017_TL_CYMD'] == null ? '' : resUserTypeJson['dm017_TL_CYMD'];			//dm017:í°ë¹ë¬´ì í ìµì¢í´ì§ì¼ - YYMMDD
var gdm018 = resUserTypeJson['dm018_LP_FYMD'] == null ? '' : resUserTypeJson['dm018_LP_FYMD'];			//dm018:ë¬´ì ííë¬ì¤ ìµì´êµ¬ë§¤ì¼ - YYMMDD
var gdm019 = resUserTypeJson['dm019_paycnt'] == null  ? '' : resUserTypeJson['dm019_paycnt'];			//dm019:ìíêµ¬ë§¤ - ì ê¸° ê²°ì ì°¨ì(ë©í°)
var gdm020 = resUserTypeJson['dm020_LP_CYMD'] == null ? '' : resUserTypeJson['dm020_LP_CYMD'];			//dm020:ë¬´ì ííë¬ì¤ ìµì¢í´ì§ì¼ - YYMMDD
var gdm021 = resUserTypeJson['dm021_MP_FYMD'] == null ? '' : resUserTypeJson['dm021_MP_FYMD']; 			//dm021:ë¬´ë¹íë¦¬ë¯¸ì ìµì´êµ¬ë§¤ì¼ - YYMMDD
var gdm022 = resUserTypeJson['dm022_MP_CYMD'] == null ? '' : resUserTypeJson['dm022_MP_CYMD'];			//dm022:ë¬´ë¹íë¦¬ë¯¸ì ìµì¢í´ì§ì¼ - YYMMDD
...
if(userId){
	...
	if(legalBirthday.length > 4){
		...
		switch(true){
			case (0 <= age && age <= 19) : ageRange='A'; break;
			case (20 <= age && age <= 29) : ageRange='B'; break;
			case (30 <= age && age <= 39) : ageRange='C'; break;
			case (40 <= age && age <= 49) : ageRange='D'; break;
			case (50 <= age && age <= 59) : ageRange='E'; break;
			case (60 <= age)  : ageRange='F'; break;
			default : ageRange='N'; break;
		}
	}else{
		ageRange='N';
	}
...
if(userId){
	switch(gender){
		case 'M' : genderRange='A'; break;
		case 'F' : genderRange='B'; break;
		default : genderRange='N'; break;
	}
}
...
if($.cookie('CURRENT_RECURPAY_DATE')){
	gaCurrentRecurpayDate = $.cookie('CURRENT_RECURPAY_DATE').replace(/"/gi,'');
...
<script type="text/javascript" src="https://image.tving.com/public_v6/portal/js/common/page.base.js?v=108"></script>

<script type="text/javascript" src="https://image.tving.com/public_v6/static/common.ad-1.0.js?v=108"></script>
<script type="text/javascript" src="https://image.tving.com/public_v6/static/common.mi-1.0.js?v=108"></script>

<!-- template 용 handlebars.js (v4.1.2) 추가 -->
<script type="text/javascript" src="https://image.tving.com/public_v6/static/lib/handlebars/handlebars.js?v=108"></script>
<!-- bxslider version up ( 2019-07-11 ) -->

<script src="https://image.tving.com/public_v6/static/lib/jquery/jquery.bxslider.min.4.2.15.js?v=108"></script>

<!-- 퍼블리싱 modernizr version 2.8.3 -->
<script type="text/javascript" src="https://image.tving.com/public_v6/static/lib/modernizr/modernizr.min.js?v=108"></script>
<!-- 4.2.2 masonry -->
<script type="text/javascript" src="https://image.tving.com/public_v6/static/lib/masonry/masonry.pkgd.min.js?v=108"></script>

<!-- recommend log -->
<script type="text/javascript" src="https://image.tving.com/public_v6/static/common.recommend.log.js?v=108"></script>

<!-- Global site tag (gtag.js) - Google Ads: 702011905 -->
<script async="" src="https://www.googletagmanager.com/gtag/js?id=AW-702011905"></script>
<script>
...
<link rel="stylesheet" type="text/css" href="https://image.tving.com/public_v6/portal/css/pass.css?v=108">
<script type="text/javascript" src="https://image.tving.com/public_v6/static/lib/jquery/jquery.history.js?v=108"></script>
  
<script src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/931058540/?random=1590367171981&amp;cv=9&amp;fst=1590367171981&amp;num=1&amp;bg=ffffff&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;u_h=1080&amp;u_w=1920&amp;u_ah=1040&amp;u_aw=1920&amp;u_cd=24&amp;u_his=6&amp;u_tz=540&amp;u_java=false&amp;u_nplug=3&amp;u_nmime=4&amp;gtm=2oa5e1&amp;sendb=1&amp;ig=1&amp;data=event%3Dgtag.config&amp;frm=0&amp;url=https%3A%2F%2Fwww.tving.com%2Fpass%2Fpass.do&amp;ref=http%3A%2F%2Fwww.tving.com%2Fmain.do%3FretRef%3DY%26source%3Dhttps%3A%2F%2Fsearch.naver.com%2Fsearch.naver%253Fsm%3Dtop_hty%2526fbm%3D1%2526ie%3Dutf8%2526query%3D%25ED%258B%25B0%25EB%25B9%2599&amp;tiba=TVING%EF%BD%9C%EC%9D%B4%EC%9A%A9%EA%B6%8C&amp;hn=www.googleadservices.com&amp;async=1&amp;rfmt=3&amp;fmt=4"></script><script src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/702011905/?random=1590367171986&amp;cv=9&amp;fst=1590367171986&amp;num=1&amp;bg=ffffff&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;u_h=1080&amp;u_w=1920&amp;u_ah=1040&amp;u_aw=1920&amp;u_cd=24&amp;u_his=6&amp;u_tz=540&amp;u_java=false&amp;u_nplug=3&amp;u_nmime=4&amp;gtm=2oa5e1&amp;sendb=1&amp;ig=1&amp;data=event%3Dgtag.config&amp;frm=0&amp;url=https%3A%2F%2Fwww.tving.com%2Fpass%2Fpass.do&amp;ref=http%3A%2F%2Fwww.tving.com%2Fmain.do%3FretRef%3DY%26source%3Dhttps%3A%2F%2Fsearch.naver.com%2Fsearch.naver%253Fsm%3Dtop_hty%2526fbm%3D1%2526ie%3Dutf8%2526query%3D%25ED%258B%25B0%25EB%25B9%2599&amp;tiba=TVING%EF%BD%9C%EC%9D%B4%EC%9A%A9%EA%B6%8C&amp;hn=www.googleadservices.com&amp;async=1&amp;rfmt=3&amp;fmt=4"></script></head>
<body data-n-head="">
...
<div id="wrap" class="page-billing">
	<div id="skipNavigationWrap">
		<a href="#gnbSearch">검색 바로가기</a>
...
<!--[s] header -->
<header id="header" class="page-pass-pass.do">
	<div id="top-gnb">
			<div class="top-wrap">
...
<script type="text/javascript">
    ...
    $(function(){
		...
		if(requestUri.indexOf("/movieList") > -1 || requestUri.indexOf("/vod/recommend/") > -1) { //무비 리스트 전체보기(신규페이지) 예외처리
        ...
        $("#gnbMenu a").on("mouseover", function (e) {
 		...
 		/* $("#gnbMenu a").each(function(index, item) {
            ...
            if(($(item).hasClass("on") && "/pass/pass.do".indexOf('player') == -1) || ($(item).hasClass("on") && "/pass/pass.do".indexOf('pick') >= 0) ) {
 ...
 */
        ...
        $("#btnSearch").on("click", function (e) {
            ...
            $("body").click(function (e) {
                if ($(".gnb-search-area").is(":visible") && $(e.target).parents("#gnbSearch").length == 0) {
                    $(".gnb-search-list").hide();
                    $("#gnbSearch").hide();
                    $('.gnb-search-area').hide();
                    $(".u-search").removeClass("on");
                }
            });
            ...
            setTimeout(function(){
                if(!isOver){
                   	...
                   	if(
                    	...
                    	var $onDom = $("#header .gnb-sub a[href='" + "/pass/pass.do" + "']");
...
<!--[s] contents -->
<div class="inner-ticket container" id="contents-wrap">

	<div class="title-group"><h3 class="large">이용권</h3></div>
	<section class="ticket-list">
			<dl>
	          <dt>아이티빙 무제한</dt>
	          <dd>
	            <p>
	              PC, 스마트폰, 태블릿, 크롬 캐스트에서
	              <br>
	              아이티빙의 모든 방송을
	              <br>
	              시청할 수 있는이용권입니다.
	            </p>
	            <p>고화질(720P)로 아이티빙을 즐겨보세요.</p>
	            <a href="<%=cp %>/proj3/pass.jsp" onclick="showPopup1();" class="btn-member">
	        ...
	        <dl class="type02">
	          ...
	          <dd>
	            <p>
	              PC, 스마트폰, 태블릿, 크롬캐스트,스마트TV에서
	              <br>
	              	영화 섹션 내 월정액 영화관의 Premium과
	              <br>
	              LITE 영화 4,000여 편을 시청할 수 있는 이용권입니다.
	            </p>
	            <p>초고화질(1080P)로 프리미엄 월정액 영화를 즐겨보세요.</p>
	            <a href="<%=cp %>/proj3/pass.jsp" onclick="showPopup2();" class="btn-member">
          ...
          <section class="ticket-table-box">
            <div class="inner-wrap">
              <h4>시청가능 콘텐츠 및 기기</h4>
              <table border="0" cellpadding="0" cellspacing="0">
                ...
                <thead>
                  <tr>
                    <th colspan="2">시청 가능 콘텐츠 및 기기</th>
                    <th>아이티빙 무제한</th>
                    <th>무비 프리미엄</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td class="left">
                      tvN, Mnet부터 JTBC, MBN까지 실시간TV 무료 시청
                      <a href="/live/player/C00551" target="_blank"><span>보러가기</span></a>
                    </td>
                  ...
                  <tr>
                    <td class="left">
                      CH.미스터션샤인, CH.맛있는녀석들등 200여개 TVING TV 무료 시청
                      <a href="/live/player/C06762?ancid=tvingtvgenre" target="_blank"><span>보러가기</span></a>
                    </td>
                    <td class="free">FREE</td>
                    <td class="free">FREE</td>
                  </tr>
                  <tr>
                    <td class="left">
							...
							실시간TV 유료채널 (OCN, OCN Movies, OCN Thrills)
						
                      <a href="/live/player/C07381" target="_blank"><span>보러가기</span></a>
                    </td>
                    <td class="ok"><span>ok</span></td>
                    <td class="ok"><span>ok</span></td>
                  </tr>
                  <tr>
                    <th>VOD</th>
                    <td class="left">
                      tvN, Mnet, JTBC, MBC 에브리원 등 VOD 시청가능 (일부 VOD 제외)
                      <a href="/vod/home" target="_blank"><span>보러가기</span></a>
                    </td>
                    <td class="ok"><span>ok</span></td>
                  ...
                  <tr>
                    ...
                    <td class="left">
                      인기 CLIP 무료 시청
                      <a href="/pick/main" target="_blank"><span>보러가기</span></a>
                    </td>
                    <td class="free">FREE</td>
                  ...
                  <tr>
                    ...
                    <td class="left">
                      월정액영화관 : 프리미엄 영화 시청 가능
                      <a href="/movie/sma" target="_blank"><span>보러가기</span></a>
                    </td>
                  ...
                  <tr>
                    <th rowspan="3">기기</th>
                    <td class="left">
                      <p>PC, 스마트폰, 태블릿, 크롬캐스트</p>
                      <p>OS 버전 및 제조사에 따라 일부 기기에서는 정상 동작하지 않을 수 있습니다.</p>
                    </td>
                    <td class="ok"><span>ok</span></td>
                  ...
                  <tr>
                    <td class="left">
                      <p>안드로이드 TV (뷰잉, TELEBEE)</p>
                      <p>일부 콘텐츠는 저작권자의 요청으로 시청이 제한될 수 있습니다.</p>
                    </td>
                    <td class="no"><span>no</span></td>
                  ...
                  <tr>
                    <td class="left">
                      <p>스마트TV (LG, 삼성)</p>
                      <p>스마트TV 버전에 따라 일부 기기에서는 정상 동작하지 않을 수 있으며, 일부 콘텐츠는 저작권자의 요청으로 시청이 제한될 수 있습니다.</p>
                    </td>
                    <td class="no"><span>no</span></td>
          ...
          <section class="ticket-guide-box">
            <div class="inner-wrap">
              <h4>구매 전 확인해 주세요.</h4>
              <div class="ticket-guide-text">
                <h5>이용권 구매 주의 사항</h5>
                <div class="guide-text">
                  <p>
                    <small class="bull">•</small>
                    자동결제는 1개월 단위로 이루어지므로 구매하신 날과 매월 동일한 날짜에 결제가 이루어지며 해당 일자가 없는 경우 해당 월의 말일에 결제가 이루어집니다.
                  </p>
                  <p>
                    <small class="bull">•</small>
                    아이티빙 무제한 이용권과 무비 프리미엄 이용권은 중복구매 하실 수 없습니다.
                  </p>
                  <p>
                    <small class="bull">•</small>
           ‘본 이용권은 방송VOD, 영화VOD 스트리밍 시청 전용 상품이며, 가입하신 상품에 따라  월정액 영화관의 영화VOD 시청 가능한 권한 <br>(LITE, Premium)에 차이가 있습니다.(영화VOD 다운로드는 별도 구매)
                  </p>
                  <p>
                    <small class="bull">•</small>
                    실시간TV의 일부 프로그램 및 VOD는 저작권자의 요청으로 시청이 제한될 수 있습니다.
                  </p>
                  <p>
                    <small class="bull">•</small>
                    실시간TV 및 VOD 서비스는 저작권자의 요청으로 해외에서 시청하실 수 없습니다.
                  </p>
                  <p>
                    <small class="bull">•</small>
                    이용권 구매 후 사용내역이 없는 경우에는 7일 이내에 고객센터를 통해 이용신청 철회를 할 수 있습니다.
                  </p>
                  <p>
                    <small class="bull">•</small>
                    7일이 경과한 이후에는 중도해지하거나, 기간만료되더라도 환불되지 않습니다.
                  </p>
                  <p>
                    <small class="bull">•</small>
                    만 14세 이상 회원만 이용권을 구매하실 수 있습니다. 미성년자의 콘텐츠 구매 시 법정대리인의 동의를 받아야하며, 동의를 받지 않은 경우 법정 대리인이 이를 취소할 수 있습니다.
                  </p>
                  <p>
                    <small class="bull">•</small>
                  ...
                  <p>
                    <small class="bull">•</small>
                    CJONE 회원 전용 이용권은 구매 금액에 따른 CJ ONE 포인트 적립(최대 5%)이 됩니다. 다만, 일반 회원용 상품은 CJ ONE 포인트 적립이 적용 되지 않습니다.
                  </p>
                </div>
                <h5>서비스 이용 주의사항</h5>
                <div class="guide-text type-01">
                  <p>
                    <small class="bull">•</small>
                    <strong>PC 권장 사양</strong>
                    <br>
                    <span>CPU : 펜티엄 4이상 / 메모리 : 512MB 이상 / 네트워크 : 3Mbps 이상 / IE10 이상</span>
                  </p>
                  <p>
                    <small class="bull">•</small>
                    <strong>스마트폰/태블릿 권장 사양</strong>
                    <br>
                    <span>
                      안드로이드 OS 4.4이상 / iOS 8.0이상
                      <br>
                      ※ OS 버전 및 제조사에 따라 일부 기기에서는 정상 동작하지 않을 수 있으므로 이용권 구매 전 미리보기를 통해 시청 가능 여부를 확인해 주세요.
                    </span>
                  </p>
                  <p>
                    <small class="bull">•</small>
                    <strong>안드로이드TV</strong>
                    <br>
                    <span>
                      현재 뷰잉, TELEBEE에서 TVING앱 이용이 가능합니다. (일부 콘텐츠는 저작권자의 요청으로 시청이 제한될 수 있습니다.)
                      <br>
                      안드로이드TV는 1080P 초고화질만 제공하여 무비 프리미엄 이용권 구매 후 이용이 가능합니다.
                    </span>
                  </p>
                  <p>
                    <small class="bull">•</small>
                    ...
                    <br>
                    <span>
                      삼성, LG 스마트TV에서 ITVING앱 이용이 가능합니다.
                      <br>
                     ※LG 스마트TV 2015년형 이상 모델(web OS 2.0 이상) / 삼성 스마트TV 2016년형 이상 모델(타이젠 2.4 이상)
                      <br>
                      ※스마트TV 버전에 따라 일부 기기에서는 정상 동작하지 않을 수 있으며, 일부 콘텐츠는 저작권자의 요청으로 시청이 제한될 수 있습니다. 스마트TV는 무비 프리미엄 이용권 구매 후 이용이 가능합니다.
                    </span>
                  </p>
                </div>
              </div>
...
<script type="text/javascript" src="https://image.tving.com/public_v6/portal/js/pass/page.pass.main.js?v=108"></script>
<script type="text/javascript">
    $(function () {
        Pass.init(getParameter(location.hash.split('#').pop(),'id'));
        History.Adapter.bind(window,'hashchange',function(){
            Pass.init(getParameter(History.getHash(), 'id'));
...
<div class="page-top-box" style="display: none;"><a href="javascript:void(0);" onclick="$(document).scrollTop(0);return;">위로</a></div>

<!--[s] footer -->
<footer id="footer">  <section class="footer-top">    <div class="inner-wrap">      
<dl class="footer-notice">       
 <dt><a href="">공지사항</a></dt>        
 <dd><a href="" id="top-notice" title="[안내] 아이티빙 유료이용약관 개정 안내 (2020년 5월 27일 수)">[안내] 아이티빙 유료이용약관 개정 안내 (2020년 5월 27일 수)</a></dd>     
 </dl>      
