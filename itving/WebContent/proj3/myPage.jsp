...
<body data-n-head="">
	<div class="chatbot-box" style="" id="ID_bounce_ani">
		<a href="javascript:void(0);" class="bounce_ani">댓글</a>
	</div>
	...
	<div id="wrap" class="page-mytving">
				...
				<div class="top-wrap">
					...
					<ul>
						...
						<li class="login_member"><a href="<%=cp%>/itving/myPage.do"><font
								color="pink">${sessionScope.customInfo.name }</font> 님</a>
		...
		<div id="contents-wrap" class="inner-favorite container">
			...
			<div class="sub-contents-wrap inner-wrap">
				...
				<div class="tab_type01">
					<ul>
						<li><a href="<%=cp%>/itving/myPage.do" class="on">찜</a></li>
						<small>|</small>
						<li><a href="<%=cp%>/itving/myBoard.do">내 글 보기</a></li>
						<small>|</small>
						<li><a href="<%=cp%>/itving/myDatgle.do">내 댓글 보기</a></li>
					</ul>
				</div>
				...
				<div class="tab-second-block cb">
					...
					<div id="EXCD0185">
						<section class="lists">
						<h2 class="section-title">찜 한 영상</h2>
						<div class="bx-wrapper" style="max-width: 956px;">
							<div class="bx-viewport" aria-live="polite"
								...
								<div class="bxslider bxslider-in" data-force="true"
									...
									<c:forEach var="dto" items="${rlists }">
										<div class="live-item column-5"
											style="float: left; list-style: none; position: relative; width: 224px; margin-right: 20px;"
											aria-hidden="false">
											<a href="<%=cp %>/itving/playVideo.do?vnum=${dto.vnum }"
												title="tvN">
												<div class="live-item__image">
													<img src="${imagePath }/${dto.ilink }" width="640"
														heigth="360" onerror="onErrorHorizontalImage(this)"
														class="image-cover" /> <span
														class="live-item__image-progress"><span
												...
												<div class="live-item__info">
													<p class="live-item__info-title">${dto.wdate }시청</p>
												</div>
											</a>
										</div>
										<c:if test="${rlists.isEmpty() }">
											<div class="mytving-nodata" style="" id="nodata">
												<p>‘찜’ 한 프로그램이 없습니다.</p>
											</div>
										</c:if>
									</c:forEach>
						...
						<div class="btn-more">
							<a href="/live/curation/PC_LIVEHOME_COLLECTION4">전체보기</a>
						</div>
						</section>
					</div>
		...
		<script id="mytvingFavoriteList_P_Template"
			type="text/x-handlebars-template">
					...
					{{/each}}
</script> <script id="mytvingFavoriteList_M_Template"
			type="text/x-handlebars-template">
					{{#each list}}
						<li data-page-no="{{pageNo}}">
						    <a href="{{linkUrl}}">
					...
					{{/each}}					
</script> <script id="mytvingFavoriteList_L_Template"
			type="text/x-handlebars-template">
	{{#each list}}
	...
	{{/each}}
</script> <!--[e] contents --> <script type="text/javascript"
