...
<script type="text/javascript">
			...
			function sendIt(){
				...
				f.action = "<%=cp%>/itving/rankUpdate_ok1.do";
				f.submit();
...
<!-- 480 X 670 -->
	<div id="wrap">
		<div id="header">
			<h1 class="single">이용권 구매 완료</h1>
				...
				<div class="pack_ch">
			<dl>
				<dt id="purchaseProdName" title="아이티빙 무제한">아이티빙 무제한</dt>
				<dd>
                      PC, 스마트폰, 태블릿, 크롬캐스트에서 티빙의 모든 방송을 시청할 수 있는 이용권입니다. 고화질(720P)로 티빙의 모든 콘텐츠를 즐겨보세요. (일부 VOD 제외)
                    				</dd>
			</dl>
		</div>
	...
	<dd>
		매월 결제 당일 회원정보에 등록된 이메일로 안내 드립니다.&nbsp;&nbsp;&nbsp;<a href="http://www.tving.com/my/user/confirmPassword.do" class="ico" target="_blank">회원정보 수정</a>
	</dd>
        ...
        <dd>
			...
			- 스마트TV 권장사양 : LG 스마트TV 2015년형 이상 모델(web OS 2.0 이상) / 삼성 스마트TV 2016년형 이상 모델(타이젠 2.4 이상)<br>
					...
					<div class="act_area">
						...
						<a href="<%=cp %>/itving/rankUpdate_ok1.do"onclick="window.close()" class="btn next" id="payBtn">확인</a> 
