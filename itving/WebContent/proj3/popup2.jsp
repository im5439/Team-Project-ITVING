...
<script language="javascript">
  function pay() { window.open("<%=cp%>/itving/pay2.do", "a", "width=500, height=700, left=100, top=50 scrollbars = yes" ); }
  </script>
	...
	<div id="wrap">
		<div id="header">
			<h1 class="single">구매하기</h1>
				...
				<div class="pack_ch">
			<dl>
				<dt id="purchaseProdName" title="무비 프리미엄">무비 프리미엄 정기권</dt>
				<dd>
    ...
    <!-- tier theme만 노출 -->
        ...
        <dd>
			...
			- 스마트TV 권장사양 : LG 스마트TV 2015년형 이상 모델(web OS 2.0 이상) / 삼성 스마트TV 2016년형 이상 모델(타이젠 2.4 이상)<br>
					...
					<div class="act_area">
						<a href="<%=cp %>/itving/pay2.do" onclick="pay2();" class="btn next" id="payBtn">다음</a> 
