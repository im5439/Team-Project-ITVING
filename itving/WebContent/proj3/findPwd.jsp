	...
	function logChk(){
		...
		<div id="gnb">
			<div class="inner-wrap">
				...
				<h2>
					<a href="javascript:logChk();" data-sub="#gnbChannel" data-nethru_clcode="A000002"
						class="nuxt-link-exact-active">게임</a>
				</h2>
				<h2>
					<a href="javascript:logChk();" data-sub="#gnbProgram" data-nethru_clcode="A000003">드라마</a>
				</h2>
				<h2>
					<a href="javascript:logChk();" data-sub="#gnbMovie" data-nethru_clcode="A000004"
						class="">예능</a>
				</h2>
				<h2>
					<a href="javascript:logChk();" data-sub="#gnbMovie" data-nethru_clcode="A000004"
		...
		<script type="text/javascript">
			...
			function sendIt(){
				...
				f.action = "<%=cp%>/itving/findPwd_ok.do";
				f.submit();
					...
					<div class="membership-login-form">
						...
						<div id="login01" class="tab-contents-login">
							<div class="login-form">
								...
								<div class="input-delete">
									<label for="b"><input type="text" placeholder="이메일" autocomplete="off" id="b" name="email"></label>
								</div>
								<a href="javascript:sendIt();" id="doLoginBtn">확인</a>
							</div>
							<div class="login-lnk cb">
								<div class="fr other">
									<a href="<%=cp%>/itving/findId.do">&nbsp;&nbsp;&nbsp;&nbsp;아이디 찾기</a> 
									<a href="<%=cp%>/itving/login.do">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;뒤로가기</a> 
								</div>
							</div>
						</div>
