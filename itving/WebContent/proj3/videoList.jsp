...
function rank() {
	...
	return;
					...
					<div id="gnbUtil" class="gnb-util">
						<div id="gnbSearch" style="display: none;">
							<div class="gnb-search-input">
								...
								<!-- <input type="text" id="autocomplete" name="autocomplete" title="keyword" 
								onkeydown="JavaScript:Enter_Check();" autocomplete="off"/> -->
								<%-- <input type="text" id="autocomplete" title="keyword" 
								onKeypress="javascript:if(event.keyCode==13) {window.location = '/itving/itving/videoList.do?category=${category }&searchValue='}"
								autocomplete="off"/> --%>
							</div>
		...
		<main>
			...
			<script id="live-home-tvingtv_Template"
				type="text/x-handlebars-template">
     <section class="lists">
       <h2 class="section-title">
         {{title}}
       </h2>
       <div class="bxslider bxslider-in" id="live-home-tvingtv-channel" data-width="300" data-min="4" data-max="4" data-margin="27" data-controls="true">

{{#each dataList}}
    <div class="live-item column-4">
	  <a href="{{linkUrl}}" title="{{channelName}}">
      <div class="live-item__image">
			<img src="{{imageUrl}}" alt="{{programName}}" onerror="onErrorHorizontalImage(this)" class="image-cover"/>
      		<span class="live-item__image-progress"><span class="live-item__image-progress-per" style="width:{{progress}}%;"></span></span>
      </div>
      <div class="live-item__info">
        <p class="live-item__info-title">
          {{{channelName}}}
        </p>
        <p class="live-item__info-subtitle">
          {{displayName}}
        </p>
      </div>
	  </a>
...
{{/each}}
       ...
       <div class="btn-more"><a href="/live/list/tvingtv">전체보기</a></div>
     </section>
</script>
			...
			<div id="EXCD0185">
				<section class="lists">
					<h2 class="section-title">${category }</h2>
						...
						<div id="EXCD0185" class="lists-wrap">
							<c:if test="${dataCount == 0 }">
								<div id="emptyboard" style="margin-left: 30rem; margin-top: 15rem">
								등록된 게시물이 없습니다.
								</div>		
							</c:if>
								
							<c:forEach var="dto" items="${lists }">								
								<div class="movie-item column-5"
									style="float: left; list-style: none; position: relative; width: 224px; height: 170px;
									margin-right: 20px; margin-top: 20px;" aria-hidden="false">
									<a href="${playVideoUrl }&vnum=${dto.vnum }">
										<div class="live-item__image">
											<img src="${imagePath }/${dto.ilink }" 
											onerror="onErrorHorizontalImage(this)" class="image-cover"/>
											<div class="thumb-summary">
												<dl onclick="">
													<dt>
														<font size="1">${dto.vtitle }</font>
														<span>${category }</span>
													</dt>
												</dl>
											</div>
