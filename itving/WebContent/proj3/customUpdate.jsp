	...
	<div id="wrap" class="page-membership">
		...
		<div id="top-gnb">
			<div class="top-wrap">
				...
				<ul>
					<li class="login_member"><a href="<%=cp %>/itving/myPage.do">${sessionScope.customInfo.name }님</a>

						<div class="gnb-hover-menu"
							style="display: none; margin-left: -50px; visibility: visible;">
							<a href="<%=cp %>/itving/myPage.do">마이아이티빙</a> <a
								href="<%=cp%>/itving/logout.do">로그아웃</a>
						</div></li>
					<li class="more_info"><a href="<%=cp%>/itving/pass.do">이용권</a>
						<div class="gnb-hover-menu"
							style="display: none; margin-left: -50px; visibility: visible;">
							<a href="<%=cp%>/itving/pass.do">이용권</a> <a
								href="javascript:billing.action.chargeCash();"
								data-nethru_type="click">캐쉬충전</a> <a
								href="http://www.tving.com/coupon/registCoupon.do">쿠폰등록</a>
						</div></li>
				</ul>
				</nav>
			</div>
		...
		<script type="text/javascript">
			...
			function sendIt(){
				...
				f.action = "<%=cp%>/itving/customUpdate_ok.do";
				f.submit();
							...
							<div class="login-form">
								<div class="input-delete">
									<label for="a"> <input type="text" id="a"
										placeholder="아이디" autocomplete="off" name="id"
										value="${dto.id }" readonly></label>
								</div>
								<div class="input-delete">
								...
								<div class="input-delete">
									<label for="a"><input type="text" id="a"
										placeholder="이름" autocomplete="off" name="name"
										value="${dto.name }" readonly></label>
								</div>
								<div class="input-delete">
									<label for="a"><input type="text" id="a"
								...
								<div class="input-delete">
									<label for="a"> <input type="text" id="a"
										placeholder="이용권" autocomplete="off" name="rank"
										value="${dto.rank }" readonly></label>
								</div>
