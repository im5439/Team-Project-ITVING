										...
										<ul class="faq-list">
											<li class="faq-list-item" data-uia-our-story="faq-list-item"><button
												...
												<div class="faq-answer closed">
													<span id="" data-uia="">아이티빙는 각종 수상 경력에 빛나는 TV 프로그램,
											...
											<li class="faq-list-item" data-uia-our-story="faq-list-item"><button
												...
												<div class="faq-answer closed">
													<span id="" data-uia="">스마트폰, 태블릿, 스마트 TV, 노트북, 스트리밍
														디바이스 등 다양한 디바이스에서 월정액 요금 하나로 아이티빙을 시청하세요. 멤버십 요금은 월
														9,900원부터 11,900원까지 다양합니다. 추가 비용이나 약정이 없습니다.</span>
												</div></li>
											<li class="faq-list-item" data-uia-our-story="faq-list-item"><button
													class="faq-question">
													어디에서 시청할 수 있나요?
												...
												<div class="faq-answer closed">
													<span id="" data-uia="">다양한 디바이스에서 언제 어디서나 시청할 수
														있습니다. 아이티빙 계정으로 로그인하면 PC에서 itving.com을 통해 바로 시청할 수 있으며,
													...
													<br>iOS, Android, Windows 10용 앱에서는 좋아하는 프로그램을 저장할 수도
														있습니다. 저장 기능을 이용해 이동 중이나 인터넷에 연결할 수 없는 곳에서도 시청하세요. 아이티빙는
														어디서든 함께니까요.
													</span>
												</div></li>
											<li class="faq-list-item" data-uia-our-story="faq-list-item"><button
											...
											<li class="faq-list-item" data-uia-our-story="faq-list-item"><button
												...
												<div class="faq-answer closed">
													<span id="" data-uia="">아이티빙는 장편 영화, 다큐멘터리, TV 프로그램,
														애니메이션, 각종 상을 수상한 넷플릭스 오리지널 등 수많은 콘텐츠를 확보하고 있습니다. 마음에 드는
											...
											<li class="faq-list-item" data-uia-our-story="faq-list-item"><button
												...
												<div class="faq-answer closed">
													<span id="" data-uia="">아이티빙를 30일 동안 무료로 이용해 보세요.
								...
								<div
									...
									<div class="site-footer-wrapper centered dark">
										...
										<div class="site-footer">
											...
											<div class="copy-text">
												<div class="copy-text-block">아이티빙 서비시스코리아 유한회사
													통신판매업신고번호: 제2018-서울종로-0426호 전화번호:</div>
												<div class="copy-text-block">대표: 임충환</div>
												<div class="copy-text-block">이메일 주소: korea@netflix.com</div>
												<div class="copy-text-block">주소: 대한민국 서울특별시 서윤구 상훈로
													26, 진수션 1동 26층 우편번호 03161</div>
