	...
	<div id="wrap" class="page-membership">
		...
		<div id="top-gnb">
			<div class="top-wrap">
				...
				<ul>
					...
					<li class="more_info"><a href="javascript:logChk();">이용권</a></li>
				</ul>
				</nav>
			</div>
		</div>
		...
		<div id="gnb">
			<div class="inner-wrap">
				<h1>
					<img
						onclick="javascript:location.href='<%=cp%>/itving/firstPage.do'"
						alt="" src="<%=cp%>/proj3/itving/logo2.jpg" width="300"
						height="20" />
				</h1>
				<nav id="gnbMenu" class="gnb-menu">
				<h2>
					<a href="javascript:logChk();" data-sub="#gnbChannel"
						data-nethru_clcode="A000002" class="nuxt-link-exact-active">게임</a>
				</h2>
				<h2>
					<a href="javascript:logChk();" data-sub="#gnbProgram"
						data-nethru_clcode="A000003">드라마</a>
				</h2>
				<h2>
					<a href="javascript:logChk();" data-sub="#gnbMovie"
						data-nethru_clcode="A000004" class="">예능</a>
				</h2>
				<h2>
					<a href="javascript:logChk();" data-sub="#gnbMovie"
						data-nethru_clcode="A000004" class="">스포츠</a>
				</h2>
				<h2>
					<a href="javascript:logChk();" data-sub="#gnbMovie"
						data-nethru_clcode="A000004" class="">영화</a>
				</h2>
				<h2>
					<a href="javascript:logChk();" data-sub="#gnbMovie"
						data-nethru_clcode="A000004" class="">커뮤니티</a>
				</h2>
		...
		<script type="text/javascript">
			...
			function sendIt(){
				...
				f.action = "<%=cp%>/itving/signUp_ok.do";
				f.submit();
							...
							<div class="login-form">
								<div class="input-delete">
									<label for="a"><input type="text" id="a"
										placeholder="아이디(영문 및 숫자 6~20자)" autocomplete="off" name="id"></label>
								</div>
								<div class="input-delete">
									<label for="b"><input type="password"
										placeholder="비밀번호(4~20자)" autocomplete="off" id="b" name="pwd"></label>
								</div>
								<div class="input-delete">
									<label for="b"><input type="password"
								...
								<div class="input-delete">
									<label for="a"><input type="text" id="a"
										placeholder="이름" autocomplete="off" name="name"></label>
								</div>
								<div class="input-delete">
									<label for="a"><input type="text" id="a"
										placeholder="이메일" autocomplete="off" name="email"></label>
								</div>
								<a href="javascript:sendIt();" id="doLoginBtn">회원가입</a>
							</div>
						</div>
