	...
	<div id="wrap" class="page-membership">
		...
		<div id="gnb">
			<div class="inner-wrap">
				<h1><img onclick="javascript:location.href='<%=cp%>/itving/login.do'" alt="" src="<%=cp%>/proj3/itving/logo2.jpg" width="300" height="20"/></h1>
				<nav id="gnbMenu" class="gnb-menu">
						...
						<h2>
							<a href="<%=cp %>/itving/boardlist.do">커뮤니티</a>
						</h2>
    ...
    padding-left:10px;
		...
		<script type="text/javascript">
			...
			function upload(){
				...
				f.action = "<%=cp%>/itving/videoUpload_ok.do";
				f.submit();
					...
					<div class="membership-login-form">
						...
						<div id="login01" class="tab-contents-login">
							<div class="login-form">
								<div class="footer-select" style="padding-bottom: 1rem; padding-left: 2rem;">
									<label for="a">
									<select name="category" style="width: 330px; height: 40px; margin-top: 7px; margin-bottom: 7px; background-color: #111111; color: white;">
										<option value="카테고리 선택" selected="selected">카테고리 선택</option>
										<option value="게임">게&nbsp;&nbsp;&nbsp;임</option>
										<option value="예능">예&nbsp;&nbsp;&nbsp;능</option>
										<option value="드라마">드&nbsp;라&nbsp;마</option>
										<option value="스포츠">스&nbsp;포&nbsp;츠</option>
										<option value="영화">영&nbsp;&nbsp;&nbsp;화</option>
									</select>
									</label>
								</div>
								<div class="input-delete">
									<label for="a"><input type="text" id="a"
										placeholder="영상이름" autocomplete="off" name="vtitle"></label>
								</div>
								<div class="input-delete">
									<label for="b"><input type="text"
										placeholder="영상URL" autocomplete="off" id="b" name="vlink"></label>
								</div>
								<div class="box-file-input" style="padding-left: 20px; padding-top: 5px;">
									<label style="background-color: red;">
										<input type="file" name="ilink" class="file-input" accept="image/*">
									</label>
									<span class="filename">파일을 선택해주세요.
								</div>
								<a href="javascript:upload();" >업로드</a>
							</div>
