...
function pwckeck() {
	var f = document.frmChk;
	if(!f.pwd.value){
		alert("\n비밀번호를 입력하세요!");
		f.pwd.focus();
		return;
	}
	f.action = "<%=cp%>/itving/delete_ok.do";
	f.submit();
}
	...
	<div id="top-gnb">
		<div class="top-wrap">
			<nav id="topUtil" class="top-util">
				<ul>
					...
					<li class="more_info">
						<a href="/pass/pass.do" data-nethru_clcode="A000010">이용권</a>
						<div class="gnb-hover-menu" style="display: none; margin-left: -50px; visibility: visible;">
							<a href="/pass/pass.do" data-nethru_clcode="A000010">이용권</a>
							<a href="javascript:billing.action.chargeCash();" data-nethru_type="click" data-nethru_clcode="A000011">캐쉬충전</a>
							<a href="/coupon/registCoupon.do" data-nethru_clcode="A000012">쿠폰등록</a>
						</div>
					</li>
				</ul>
			</nav>
  	...
  	<div id="gnb">
    	<div class="inner-wrap">
			<h1><a href="<%=cp %>/itving/main.do" data-nethru_clcode="A000001">TVING</a></h1>
			<nav id="gnbMenu" class="gnb-menu">
                <h2><a href="/live/home" data-sub="#gnbChannel" data-nethru_clcode="A000002" class="nuxt-link-exact-active ">게임</a></h2>
				<h2><a href="/vod/home" data-sub="#gnbProgram" data-nethru_clcode="A000003">드라마</a></h2>
				<h2><a href="/movie/home" data-sub="#gnbMovie" data-nethru_clcode="A000004">예능</a></h2>
				<h2><a href="/pick/main" data-sub="#gnbPick">스포츠</a></h2>
				<h2><a href="/pick/main" data-sub="#gnbPick">커뮤니티</a></h2>
      		</nav>
    	</div>
	</div>
</header>
    ...
    <div class="sub-contents-wrap inner-wrap">
        <form action="/my/user/confirmPasswordProc.do" name="frmChk" id="frmChk" method="post">
            <div class="title-group">
                <h3 class="large">회원 정보 수정</h3>
            </div>
            <section class="coupon-regist-box">
                <h4>회원 탈퇴를 위해 비밀번호를 입력해주세요.</h4>
                <p>회원님의 개인 정보 보호를 위해 비밀번호를 확인합니다.</p>

                <div class="form-box">
                    <input type="password" id="PWD" name="pwd" placeholder="비밀번호">
                    <input type="button"onclick="javascript:pwckeck();" value="확인" style="color: black;">
                </div>
