  	...
  	<div id="gnb">
    	<div class="inner-wrap">
			...
			<nav id="gnbMenu" class="gnb-menu">
                <h2><a href="<%=cp%>/itving/firstPage.do">게임</a></h2>
				<h2><a href="<%=cp%>/itving/firstPage.do">드라마</a></h2>
				<h2><a href="<%=cp%>/itving/firstPage.do">예능</a></h2>
				<h2><a href="<%=cp%>/itving/firstPage.do">스포츠</a></h2>
				<h2><a href="<%=cp%>/itving/firstPage.do">영화</a></h2>
				<h2><a href="<%=cp%>/itving/firstPage.do">커뮤니티</a></h2>
      		</nav>
    	</div>
	</div>
</header>
