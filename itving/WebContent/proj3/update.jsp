	...
	<div id="wrap" class="page-membership">
		...
		<div id="top-gnb">
			<div class="top-wrap">
				...
				<ul>
					<li class="login_member">
								<a href="<%=cp %>/itving/myPage.do">${sessionScope.customInfo.name }님</a>
	
								<div class="gnb-hover-menu" style="display: none; margin-left: -50px; visibility: visible;">
									<a href="<%=cp %>/itving/myPage.do">마이티빙</a>
									<a href="<%=cp%>/itving/logout.do">로그아웃</a>
                        		</div>
                    		</li>
					<li class="more_info"><a
						...
						<div class="gnb-hover-menu"
							...
							<a href="">이용권</a>
							<a href="javascript:billing.action.chargeCash();" data-nethru_type="click">캐쉬충전</a>
							<a href="http://www.tving.com/coupon/registCoupon.do">쿠폰등록</a>
						</div></li>
				</ul>
				</nav>
			</div>
		...
		<div id="gnb">
			<div class="inner-wrap">
				<h1>
					<a href="<%=cp%>/itving/main.do" class="on"
						data-nethru_clcode="A000001">ITVING</a>
				</h1>
				<nav id="gnbMenu" class="gnb-menu">
				<h2>
					<a href="" data-sub="#gnbChannel" data-nethru_clcode="A000002"
						class="nuxt-link-exact-active">게임</a>
				</h2>
				<h2>
					<a href="" data-sub="#gnbProgram" data-nethru_clcode="A000003">드라마</a>
				</h2>
				<h2>
					<a href="" data-sub="#gnbMovie" data-nethru_clcode="A000004"
						class="">예능</a>
				</h2>
				<h2>
					<a href="" data-sub="#gnbMovie" data-nethru_clcode="A000004"
		...
		<script type="text/javascript">
			...
			function sendIt(){
				...
				f.action = "<%=cp%>/itving/update_ok.do";
				f.submit();
						...
						<div id="login01" class="tab-contents-login">
							<div class="login-form">
								<div class="input-delete">
									<label for="a"><input type="text" id="a"
										placeholder="아이디" autocomplete="off" name="id" value="${dto.id }"></label>
								</div>
								<div class="input-delete">
									<label for="b"><input type="password"
										placeholder="비밀번호" autocomplete="off" id="b" name="pwd"></label>
								</div>
								<div class="input-delete">
									<label for="b"><input type="password"
										placeholder="비밀번호 확인" autocomplete="off" id="b" name="pwd2"></label>
								</div>
								<div class="input-delete">
									<label for="a"><input type="text" id="a"
										placeholder="이름" autocomplete="off" name="name" value="${dto.name }"></label>
								</div>
								<div class="input-delete">
									<label for="a"><input type="text" id="a"
										placeholder="이메일" autocomplete="off" name="email"></label>
								</div>
								<a href="javascript:sendIt();" id="doLoginBtn">수정완료</a>
							</div>
						</div>
		...
		</main> <!--[e] contents --> <!--[s] footer --> <!--[s] footer --> <footer
			id="footer"> <section class="footer-top">
		<div class="inner-wrap">
			<dl class="footer-notice">
				<dt>공지사항</dt>
				<dd>[안내] 신규 해외시리즈 론칭 안내</dd>
			</dl>
		</div>
		</section>
	</div>
