...
<body data-n-head="">
	...
	function sendIt(){
		...
		f.action = "<%=cp%>/itving/boardcreated_ok.do";
						f.submit();
				...
				<form action="" method="post" name="myForm"
					...
					<table>
						...
						<tr>
							...
							<td>
								<%-- <input type="hidden"
					name="dat_id" size="35" maxlength="20" class="boxTF"
					value="${rdto.re_id }">${rdto.re_id } --%> <input type="text"
								name="re_id" size="35" maxlength="20" class="boxAA"
								style="width: 300px; margin-top: 7px;" readonly="readonly"
								value="${id }" />
							</td>
						</tr>
						...
						<tr>
							<td>내&nbsp;&nbsp;&nbsp;&nbsp;용</td>
							<td><textarea rows="12" cols="63" name="content"></textarea></td>
						...
						<tr>
							...
							<!-- <input type="button" class="btn-box board" value="업로드"
								...
								버튼 클릭시 파일찾기로 링크해 준다 <input type="file" name="fileName"
				...
				<div class="btn-area ar">
					<tr>
						<td colspan="2"><input type="button" value="등록하기"
							class="btn-box board" onclick="sendIt();" /> <input type="reset"
							value="다시입력" class="btn-box board"
							onclick="document.myForm.subject.focus()" /> <input
							type="button" value="작성취소" class="btn-box board"
							onclick="javascript:location.href='<%=cp%>/itving/boardlist.do';" />
						</td>
					</tr>
				</div>
			</div>
